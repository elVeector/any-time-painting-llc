...
export default function Home() {
  ...
  return <main>
    ...
    <footer><div className="footer-brand"><img src="/any-time-painting-logo.jfif" alt="Any Time Painting LLC"/><p>Servicio profesional de pintura para hogares, oficinas y negocios en Chino y comunidades cercanas.</p></div><div><b>Explora</b><a href="#servicios">Servicios</a><a href="#ventajas">Por qué elegirnos</a><a href="#galeria">Resultados</a></div><div><b>Contacto</b><a href={`tel:+${phone}`}>(626) 614-4419</a><a href="mailto:anytimepainting2024@gmail.com">anytimepainting2024@gmail.com</a><a href="https://www.instagram.com/paintinganytime?igsi=cHM5d25hMmwwODNp" target="_blank" rel="noreferrer">Instagram ↗</a></div><div className="copyright">© 2026 Any Time Painting LLC</div></footer>
